...
- Preserved Decodium's host-environment launcher when packaging aarch64
  AppImages, made final payload validation architecture-safe and added clear
...
- Preservato il launcher dell’ambiente host durante la creazione delle AppImage
  aarch64; reso inoltre indipendente dall’architettura il controllo finale del
  contenuto, con diagnostica esplicita per componenti QML, launcher e runtime
  RTL-SDR mancanti.
